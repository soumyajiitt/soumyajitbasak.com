...
export default function Hero() {
	...
	return (
		<section
			ref={containerRef}
			className='sticky top-0 h-screen w-full flex flex-col justify-between bg-background px-container md:px-16 pt-28 pb-12 sm:pt-32 sm:pb-16 2xl:pb-24 overflow-hidden relative isolate'
			id='home'
		>
			...
			<motion.div
				...
				className='relative z-20 flex-1 flex flex-col gap-6 sm:gap-8 xl:gap-12 justify-end w-full h-full will-change-[opacity,transform]'
			>

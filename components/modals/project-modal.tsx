                    ...
                    <div className="relative w-full h-[40vh] sm:h-[50vh] shrink-0">
                        ...
                        <div className="absolute bottom-6 left-6 right-6 sm:bottom-10 sm:left-10 sm:right-10 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                            <div>
                                ...
                                {project.status && (
                                    <span className="mb-3 inline-flex items-center gap-2 rounded-full border border-primary/40 bg-background/70 px-3 py-1 text-[10px] font-medium uppercase tracking-[0.18em] text-primary backdrop-blur-sm">
